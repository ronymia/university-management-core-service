...
router
    .route('/my-courses')
    .get((0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.STUDENT), student_controller_1.StudentController.myCourses);
router
    .route('/my-semester-reg-courses')
    .get((0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.STUDENT), student_controller_1.StudentController.mySemesterRegCourses);
router
    .route('/my-course-schedules')
    .get((0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.STUDENT), student_controller_1.StudentController.myCourseSchedules);
router
    .route('/my-academic-info')
    .get((0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.STUDENT), student_controller_1.StudentController.myAcademicInfo);
